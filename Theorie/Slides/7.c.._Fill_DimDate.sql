...
CREATE OR ALTER PROCEDURE FillDimDate @StartDate DATETIME,  @EndDate DATETIME
AS
BEGIN
...
/* Populate Your Dimension Table with values*/
	...
	SELECT
		...
		CONVERT (char(10),@CurrentDate,23) as FullDateAlternateKey,
		DATEPART(DD, @CurrentDate) AS DayOfMonth,
		DATENAME(DW, @CurrentDate) AS EnglishDayNameOfWeek,
		FORMAT(@CurrentDate, 'dddd', 'nl-NL') AS DutchDayNameOfWeek,
		...
		FORMAT(@CurrentDate, 'MMMM', 'nl-NL') AS DutchMonthName,
		CASE
